...
implements NodeEditPart {
    ...
    private Adapter adapter = new LightweightEContentAdapter(this::eCoreChanged, IFeature.class, IProperty.class);
    ...
    protected void eCoreChanged(Notification msg) {
        ...
        // Archi Features and Properties
        if(feature == IArchimatePackage.Literals.FEATURES__FEATURES || msg.getNotifier() instanceof IFeature
                || feature == IArchimatePackage.Literals.PROPERTIES__PROPERTIES || msg.getNotifier() instanceof IProperty) {
            refreshFigure();
            return;
        }
